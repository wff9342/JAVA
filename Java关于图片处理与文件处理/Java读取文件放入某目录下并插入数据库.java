...
public class MainTest {
	...
	public static void main(String[] args) throws Exception {
		File resultRoot = new File("I:\\新建文件夹");
		File[] resultDirs = resultRoot.listFiles();
		String path = "D:\\eclipse-workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\videomark\\store";
		for (File resultDir : resultDirs) {
			...
			originalFileId = json.getJSONArray("photolist").getJSONObject(0).getString("original_file_id");
