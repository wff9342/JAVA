...
public class Demo_2 {
	...
	public static void getTxt(File file,File filetwo,int x,String url) throws IOException {		
		...
		String head = "{\"taskid\":\"1\",\"videolist\":[],\"photolist\":[{\"photoID\":\"Photo_0_\",\"mark\":\"yes\",\"url\":\"\","
				+ "\"original_file_id\":\"" + UUID.randomUUID().toString() + "\",\"" ;											
	...
	public static String temp(File file) {
		...
		try {
			...
			while((s = br.readLine()) != null) {
				...
				String str = getJson(name,post, xmin, ymin, xmax, ymax);
	...
	public static String getJson(String name, String pose, String xmin, String ymin, String xmax, String ymax) {		
		String json1 ="masker\":["+"{\"maskerID\":\"Photo_0_car_0_\",\"name\":\"" + name+ "\",\"mark\":[ {\"markID\":\"Photo_0_car_0_rec_0_\"," + "\"pose\":\"" + pose
